...
$MESS["ECL_P_CUR_USER_EVENT_LIST"] = "Afficher les évènements d'un utilisateur courant";
$MESS["ECL_P_DETAIL_URL"] = "Adresse de la page pour une consultation détaillée";
$MESS["ECL_P_EVENTS_COUNT"] = "Quantité d'évènements dans la liste";
$MESS["ECL_P_EVENT_LIST_MODE"] = "Afficher uniquement la liste des évènements";
$MESS["ECL_P_FUTURE_MONTH_COUNT"] = "Montrer les évènements les plus proches pour nombre de mois";
$MESS["ECL_P_INIT_DATE"] = "Date de l'initialisation";
$MESS["ECL_P_LOAD_MODE"] = "Chargement des évènements";
