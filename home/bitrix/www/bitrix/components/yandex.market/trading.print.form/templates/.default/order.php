		...
		if ($item['GROUP'] !== $activeGroup || !$isGroupStarted)
		{
			...
			<div class="yamarket-shipment-print-orders-header">
				<input
					...
					data-table-element="#yamarket_PRINT_ORDERS_<?= $activeGroup; ?>"
					id="yamarket_PRINT_ORDER_<?= $activeGroup; ?>"
				/><?php
				?><label class="adm-designed-checkbox-label" for="yamarket_PRINT_ORDER_<?= $activeGroup; ?>"></label><?php
				?><label class="yamarket-shipment-print-orders__gap" for="yamarket_PRINT_ORDER_<?= $activeGroup; ?>"><?php
					?><strong><?= $groupTitle; ?></strong><?php
				?></label>
			</div>
			<table class="yamarket-shipment-print-orders" id="yamarket_PRINT_ORDERS_<?= $activeGroup; ?>">
				<thead>
					<tr>
						<td>&nbsp;</td>
