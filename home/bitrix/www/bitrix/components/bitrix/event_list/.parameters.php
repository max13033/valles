...
$arComponentParameters = Array(
	...
	"PARAMETERS" => Array(
		...
		"USER_PATH" => Array(
			...
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "s2company/personal/user/#user_id#/",
			"COLS" => 40,  
		...
		"FORUM_PATH" => Array(
			...
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "s2community/forum/forum#FORUM_ID#/",
			"COLS" => 40,
			"PARENT" => "URL_TEMPLATES",
		),
		"FORUM_TOPIC_PATH" => Array(
			...
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "s2community/forum/forum#FORUM_ID#/topic#TOPIC_ID#/",
			"COLS" => 40,
			"PARENT" => "URL_TEMPLATES",
		),
		"FORUM_MESSAGE_PATH" => Array(
			...
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "s2community/forum/messages/forum#FORUM_ID#/topic#TOPIC_ID#/message#MESSAGE_ID#/#message#MESSAGE_ID#",
			"COLS" => 40,
			"PARENT" => "URL_TEMPLATES",
		),		
	)
