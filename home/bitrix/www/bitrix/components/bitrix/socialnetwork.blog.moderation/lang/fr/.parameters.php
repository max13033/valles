...
$MESS["BB_MESSAGE_COUNT"] = "Nombre de messages affichés sur la page";
...
$MESS["BB_PATH_TO_GROUP"] = "Modèle de chemin d'accès à la page d'un groupe";
...
$MESS["BB_PATH_TO_USER"] = "Modèle de chemin d'accès au profil de l'utilisateur";
$MESS["BB_POST_VAR"] = "Nom de la variable pour l'identificateur du message";
$MESS["BB_SET_NAV_CHAIN"] = "Ajouter un élément dans le fil d'Ariane";
$MESS["BB_USER_VAR"] = "Nom de la variable pour le code d'utilisateur";
