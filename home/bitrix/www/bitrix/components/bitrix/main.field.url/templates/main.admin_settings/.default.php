...
<tr>
	<td>
		<?= Loc::getMessage('USER_TYPE_URL_POPUP') ?>:
	</td>
	<td>
		<input
			type="hidden"
...
<tr>
	<td>
		<?= Loc::getMessage('USER_TYPE_STRING_DEFAULT_VALUE') ?>:
	</td>
	<td>
		<input
			type="text"
...
<tr>
	<td>
		<?= Loc::getMessage('USER_TYPE_STRING_SIZE') ?>:
	</td>
	<td>
		<input
			type="text"
...
<tr>
	<td>
		<?= Loc::getMessage('USER_TYPE_STRING_MIN_LEGTH') ?>:
	</td>
	<td>
		<input
			type="text"
...
<tr>
	<td>
		<?= Loc::getMessage('USER_TYPE_STRING_MAX_LENGTH') ?>:
	</td>
	<td>
		<input
			type="text"
