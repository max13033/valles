							...
							'<div class="inner_wrap">'+
								...
								'<div class="item_info">'+
									...
									'<div class="cost prices clearfix">'+
										(item.MIN_PRICE ?
											('<div class="price only_price">' + (item.MIN_PRICE.PRINT_DISCOUNT_VALUE == '<span class="price_value">0</span><span class="price_currency"> руб.</span>' 
												? 'По запросу' : item.MIN_PRICE.PRINT_DISCOUNT_VALUE))
											: '')+
									'</div>'+
								'</div>'+ 
							'</div>'
